...
def main():
    ...
    parser.add_argument('--validation', type=bool, default=True, help='validation status')
    ...
    parser.add_argument('--target', type=str, default='INSP', help='target feature in S or MS task')
